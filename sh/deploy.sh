...
aws elasticbeanstalk create-application-version --application-name coinstreams --version-label $SHA1 --source-bundle S3Bucket=$EB_BUCKET,S3Key=coinstreams/streams-$SHA1.zip
